...
namespace WoolichDecoder.Models
{
    public static class PacketTypeIdentification
    {
        ...
        public static (PacketFormat, byte[]) HondaOBD = (PacketFormat.HondaOBD, new byte[] { 0x28, 0x02, 0x03, 0x01, 0x04, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00 });
        ...
        public static PacketFormat IdentifyPacketType(byte[] primaryHeaderData)
        {
            ...
            if (MatchesFirst10Bytes(primaryHeaderData, HondaOBD.Item2))
                return HondaOBD.Item1;
